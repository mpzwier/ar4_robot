...
def generate_launch_description():
    ...
    robot_description_semantic_content = Command([
        ...
        " ",
        PathJoinSubstitution([
            FindPackageShare("ar4_robot"), "srdf",
            "ar.srdf.xacro"
        ]),
        " ",
        "name:=",
    ...
    ompl_planning_yaml = load_yaml("ar4_robot",
                                   "config/ompl_planning.yaml")
    pilz_planning_yaml = load_yaml("ar4_robot",
    ...
    rviz_base = os.path.join(
        get_package_share_directory("ar4_robot"), "rviz")
    ...
    ros2_controllers = ParameterFile(PathJoinSubstitution(
        [FindPackageShare("ar4_robot"), "driver", "controllers.yaml"]),
                                     allow_substs=True)
